...
class Command(BaseCommand):
    ...
    def handle(self, **options):
        ...
        em1 = EmployeeFactory.create(project=proj, space=SpaceFactory(location=proj.location))
        EmployeeFactory.create(project=proj, company=em1.company, team=em1.team,
                               space=SpaceFactory(location=proj.location))
        EquipmentFactory.create(project=proj, company=em1.company, team=em1.team,
                                space=SpaceFactory(location=proj.location, identifier='WH1'))
