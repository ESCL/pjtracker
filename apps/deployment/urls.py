...
urlpatterns = [
    ...
    url(r'^timesheets/(?P<action>add)/$', TimeSheetView.as_view(), name='timesheet-edit'),
    url(r'^timesheets/(?P<pk>\d+)/$', TimeSheetView.as_view(), name='timesheet'),
    url(r'^timesheets/(?P<pk>\d+)/(?P<action>edit)/$', TimeSheetView.as_view(), name='timesheet-edit'),
