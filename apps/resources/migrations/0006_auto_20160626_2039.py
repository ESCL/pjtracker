# -*- coding: utf-8 -*-
# Generated by Django 1.9.7 on 2016-06-26 20:39
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('assignment', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='actions', to='resources.ResourceProjectAssignment')),
                ('owner', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='accounts.Account')),
            ],
            options={
                'abstract': False,
